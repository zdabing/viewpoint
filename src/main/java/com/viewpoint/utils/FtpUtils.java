...
public class FtpUtils {
    // ftp服务器地址
    public String hostname = "192.168.1.145";
    // ftp服务器端口号默认为21
    public Integer port = 21;
    // ftp登录账号
    public String username = "ftp_test";
    // ftp登录密码
    ...
    public boolean existFile(String path) throws IOException {
        InputStream is = ftpClient.retrieveFileStream(new String(path
    ...
    public static void main(String[] args) {
        ...
        // 文件路径写为用户建立时 指定的目录
        //ftp.uploadFile("/2018/08/01", "123132.png", "F:\\123.png");
        // ftp.downloadFile("/home/ftpFile", "123.png", "E://");
        ftp.deleteFile("/home/ftp_test/2018/08/01", "123132.png");
